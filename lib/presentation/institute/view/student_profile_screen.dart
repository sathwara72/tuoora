...
class StudentProfileScreen extends GetView<InstituteStudentController> {
                        ...
                        children: [
                          ...
                          if (student != null &&
                              (student.fees.isNotEmpty ||
                                  (num.tryParse(student.monthlyFee ?? '0') ?? 0) > 0 ||
  ...
  Widget _buildFeeSummaryCard(Student student) {
    final monthlyFeeVal = student.monthlyFee != null && student.monthlyFee!.isNotEmpty
        ? student.monthlyFee!
        : '0';
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Overview of tuition, installments, and receipts',
                      style: AppTextStyles.outfit(
                        fontSize: 11,
